  ...
  >
    <g>
      ...
      <path
       ...
       c0-11.402,9.243-20.645,20.645-20.645h0c11.402,0,20.645,9.243,20.645,20.645v16.516C189.935,246.757,180.692,256,169.29,256z"
      />
      <path
        style={{ fill: '#9C6846' }}
      ...
      <path
       ...
       c0-11.402,9.243-20.645,20.645-20.645h0c11.402,0,20.645,9.243,20.645,20.645v16.516C363.355,246.757,354.112,256,342.71,256z"
      />
      <path
        style={{ fill: '#9C6846' }}
      ...
      <g>
        <g>
          <path
            style={{ fill: '#AA7346' }}
            d="M173.387,381.935c-2.5,0-5.008-0.903-6.992-2.726c-4.194-3.863-4.468-10.391-0.605-14.589
